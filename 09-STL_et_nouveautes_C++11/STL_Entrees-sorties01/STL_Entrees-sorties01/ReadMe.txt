========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet STL_Entrees-sorties01
========================================================================

AppWizard a créé cette application STL_Entrees-sorties01 pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application STL_Entrees-sorties01.


STL_Entrees-sorties01.vcxproj
...
STL_Entrees-sorties01.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) STL_Entrees-sorties01.pch et un fichier de type précompilé nommé StdAfx.obj.
