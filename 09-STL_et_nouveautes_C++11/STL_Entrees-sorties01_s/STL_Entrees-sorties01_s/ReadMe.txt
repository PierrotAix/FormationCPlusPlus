========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet STL_Entrees-sorties01_s
========================================================================

AppWizard a créé cette application STL_Entrees-sorties01_s pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application STL_Entrees-sorties01_s.


STL_Entrees-sorties01_s.vcxproj
...
STL_Entrees-sorties01_s.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) STL_Entrees-sorties01_s.pch et un fichier de type précompilé nommé StdAfx.obj.
